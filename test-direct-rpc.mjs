...
async function testRPC() {
  console.log('Testing RPC function simple_search_drugs...\n');

  try {
    const response = await fetch(`${SUPABASE_URL}/rest/v1/rpc/simple_search_drugs`, {
      method: 'POST',
      headers: {
      ...
      body: JSON.stringify({ search_text: 'jardiance' })
    });
